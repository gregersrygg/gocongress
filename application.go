...
// NewDeviceOTAA creates a new OTAA (Over The Air Activated) device in Congress.
...
// NewDeviceABP creates a new ABP (Activation By Personalization) device in Congress.
